...
resPath1 = fullfile(RootDir,'result12');
resPath2 = fullfile(RootDir,'result22');
...
costfunction=@(x,C)ThetaFit2(x,C);
...
for i=1:vall    
 ...
 a11=xyz(1,i)*(128-vmin)+vmin;
 b11=xyz(2,i)*(255-128)+128;

slaps(i).position=[a11,b11];%mapping to range space
...
% percentege=0;
  ...
  % figure(2);
  %  imshow(z);
%title(' Segmentation Result of Improved Algorithm(6)');
